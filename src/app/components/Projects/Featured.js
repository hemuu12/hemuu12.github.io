...
import BeautyBebo from "../../assets/featured/BeautyBebo.png";
import socialhub from "../../assets/featured/socialhub.png";
import yoox from "../../assets/featured/yoox.png";
import youtube from "../../assets/featured/youtube.png";
import Glowup from "../../assets/featured/Glowup.png"
...
const Featured = ({data, mirror}) => {
	...
	const selectImage = (name) => {
		if (name === "Socialhub") return socialhub;
		else if (name === "BeautyBebo") return BeautyBebo;
		else if(name === "YoutubeClone") return youtube;
		else if(name === "Glowup") return Glowup;
 		return yoox;
	};
